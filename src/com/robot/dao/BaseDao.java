...
import com.robot.dao.inte.IBaseDao;
...
public class BaseDao<T> extends HibernateDaoSupport implements IBaseDao<T> {
	...
	//	System.out.println("final:"+args.length+q.toString());
		return q;
	}
	...
	public Object load(Object obj,String proty,String vaule)
	{
		String hql="select t from"+obj.getClass().getName()+" t where t." + proty+"="  +vaule;
