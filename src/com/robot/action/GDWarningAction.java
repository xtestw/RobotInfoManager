...
import com.robot.service.PointCoordService;
...
@Controller("gdWarningAction")
@Scope("prototype")
public class GDWarningAction extends ActionSupport {
	...
	public String query()
	{
	    ...
	    Setting gd=settingService.getParam("QJGD");
	    Setting gdv=settingService.getParam("QJGDV");
		pointCoords=pointCoordService.listGD(getPGName(),cp.getValue());
	    pointInfos=pointCoordService.listGDWarningPoint(pointCoords, gd, gdv);
