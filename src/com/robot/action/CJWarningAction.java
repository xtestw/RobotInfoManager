...
public class CJWarningAction extends ActionSupport {
	...
	public String query()
	{
	    ...
	    Setting cp=settingService.getParam("CJ");
		System.out.println("CJ done!");
	    Setting cpv=settingService.getParam("CJV");
		System.out.println("CJV done!");
		pointCoords=pointCoordService.listCJ(getPGName());
	    System.out.println(pointCoords.size()+" "+cp.getValue()+" "+cpv.getValue());
	    pointInfos=pointCoordService.listCJWarningPoint(pointCoords,cp,cpv);
