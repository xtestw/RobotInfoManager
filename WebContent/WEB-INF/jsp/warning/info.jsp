 ...
 <div class="content" style="min-height: 1000px">
		...
		<h2>个人账号设置</h2>
	       ...
	       <div id="modal-container-774920" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<form role="form" class="form-horizontal" action="warning_update.action" id="warning_form" method="post">
                ...
                <span class="span6">车站拱顶速率沉降限差(mm)</span>
                    <input type="text" class="span6" name="CZGDV" id="QJGD" value="${warningSetting.QJGD}">
                  </div>
                     <div class="form-group">
                ...
                <span class="span6">区间拱顶沉降速率限差(mm)</span>
                    <input type="text" class="span6" name="CZGDV" id="QJGDV" value="${warningSetting.QJGDV}">
                  </div> <div class="form-group">
                 <span class="span6">水平收敛值限差(mm)</span>
                    <input type="text" class="span6" name="CZGDV" id="SL" value="${warningSetting.SL}">
                 </div> <div class="form-group">
                <span class="span6">水平收敛值速率限差(mm)</span>
                    <input type="text" class="span6" name="CZGDV" id="SLV" value="${warningSetting.SLV}">
                </div>  <div class="form-group">
                <span class="span6">倾斜度限差(mm)</span>
                    <input type="text" class="span6" name="CZGDV" id="QX" value="${warningSetting.QX}">
                 </div> <div class="form-group">
                <span class="span6">倾斜度速率限差(mm)</span>
                    <input type="text" class="span6" name="CZGDV" id="QXV" value="${warningSetting.QXV}">
                 </div>  <div class="form-group">
               <span class="span6">沉降值限差(mm)</span>
                    <input type="text" class="span6" name="CZGDV" id="CJ" value="${warningSetting.CJ}">
                 </div>  <div class="form-group">
               <span class="span6">沉降值速率限差(mm)</span>
                    <input type="text" class="span6" name="CZGDV" id="CJV" value="${warningSetting.CJV}">
                </div>   	</form>
				</div>
